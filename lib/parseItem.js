...
const parseItem = item => {
  ...
  return {
    title: url.parseText(info.title, ''),
    index: info.index ? url.parseIntegerFromText(info.index) : -1,
    id: info.videoId,
    ...
    isLive,
    duration: !info.lengthText ? null : url.parseText(info.lengthText),
