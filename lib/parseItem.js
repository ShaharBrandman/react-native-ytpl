...
const util = require('react-native-url-polyfill');
...
const parseItem = item => {
  ...
  return {
    ...
    url: util.resolve(BASE_VIDEO_URL, info.navigationEndpoint.commandMetadata.webCommandMetadata.url),
    author: {
      url: util.resolve(BASE_VIDEO_URL, author.navigationEndpoint.commandMetadata.webCommandMetadata.url),
